...
<head>
        ...
        <!-- Basic Styles -->
        <link rel="stylesheet" type="text/css" media="screen" href="<s:url value="/css/bootstrap.min.css"/>">
        <link rel="stylesheet" type="text/css" media="screen" href="<s:url value="/css/font-awesome.min.css" />">

        <!-- SmartAdmin Styles : Please note (smartadmin-production.css) was created using LESS variables -->
        <link rel="stylesheet" type="text/css" media="screen" href="<s:url value="/css/smartadmin-production.css" />">
        <link rel="stylesheet" type="text/css" media="screen" href="<s:url value="/css/smartadmin-skins.css" />">

        <!-- FAVICONS -->
        <link rel="shortcut icon" href="<s:url value="/img/favicon/favicon.ico"/>" type="image/x-icon">
        <link rel="icon" href="<s:url value="/img/favicon/favicon.ico"/>" type="image/x-icon">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="text-center error-box">
                                    <h2 class="font-xl"><strong><i class="fa fa-fw fa-warning fa-lg text-warning"></i> 页面参数异常</strong></h2>
                                    <br />
                                    <p class="lead">
                                                                                                                        你所请求的页面存在参数异常，请联系系统管理员。
                                    </p>
                                    <p class="font-md">
