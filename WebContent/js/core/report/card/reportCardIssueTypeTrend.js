/**
 * FileName: reportCardIssueTypeTrend.js
 *
	...
	return {
		...
		initEvent:function(){
	        ...
	        $(".exportExcel").click(function(e){
				...
				window.location=$.url_root+'/report/exportCardIssueTypeTrend.jspa?reportQueryCondition.startDate='+startDate+'&'+'reportQueryCondition.endDate='+endDate;
	        });
		},
		stat:function(){
			...
			var url=$.url_root+"/report/loadCardIssueTypeTrend.jspa";
	    	$.ajax({
				url: url, 
				type : "post",
				traditional : true,
					...
					checkResult(result, {
	    				...
	    				callback : function(){
	    					var dtos=result.issueDTOList;
	    					 IssueTypeTrend.generatePageGraphs(dtos);
	    					 IssueTypeTrend.doInitTable(dtos);
	    				}
	    			});
				},
			...
			IssueTypeTrend.generatePageGraphs(sourcedata);
			IssueTypeTrend.doInitTable(sourcedata);*/
	    },
		generatePageGraphs:function(sourceData) {
	        ...
	        var toggles = $("#rev-toggles_B"),
	            target = $("#flotcontainer_B");
