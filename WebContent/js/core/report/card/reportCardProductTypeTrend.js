/**
 * FileName: reportCardProductTypeTrend.js
 *
	...
	return {
		...
		initEvent:function(){
	        ...
	        $("#btnStat").click(function(e){
	        	ProductTypeTrend.stat();
	        });
	        
	        $(".exportExcel").click(function(e){
	        	var startDate=$("#EpStartDate").val();
				var endDate=$("#EpEndDate").val();
				window.location=$.url_root+'/report/exportCardProductTypeTrend.jspa?reportQueryCondition.startDate='+startDate+'&'+'reportQueryCondition.endDate='+endDate;
	        });
		},
		stat:function(){
			...
			var url=$.url_root+"/report/loadCardProductTypeTrend.jspa";
	    	$.ajax({
				url: url, 
				type : "post",
				traditional : true,
					...
					checkResult(result, {
	    				...
	    				callback : function(){
	    					var dtos=result.issueDTOList;
	    					 ProductTypeTrend.generatePageGraphs(dtos);
	    					 ProductTypeTrend.doInitTable(dtos);
	    				}
	    			});
				},
			...
			ProductTypeTrend.generatePageGraphs(sourcedata);
			ProductTypeTrend.doInitTable(sourcedata);*/
	    },
		generatePageGraphs:function(sourceData) {
	        ...
	        var toggles = $("#rev-toggles_C"),
	            target = $("#flotcontainer_C");
